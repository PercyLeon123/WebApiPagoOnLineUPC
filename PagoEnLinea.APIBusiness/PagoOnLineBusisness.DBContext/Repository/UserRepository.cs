        ...
        public ResponseBase Login(EntityLogin login)
        {
            ...
            try
            {
                using (var db = GetSqlConnection())
                {
                    ...
                    var p = new DynamicParameters();
                    p.Add(name: "@logincontribuyente", value: login.LoginUsuario, dbType: DbType.String, direction: ParameterDirection.Input);
                    p.Add(name: "@contracena", value: login.PasswordUsuario, dbType: DbType.String, direction: ParameterDirection.Input);
